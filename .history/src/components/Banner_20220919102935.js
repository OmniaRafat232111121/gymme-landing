...
<div className='flex items-center h-full relativ'>
...
<div className='bg-purple-50 w-full h-full bg-cover bg-right bg-banner lg:bg-center bg-no-repeat flex-1'>image</div>
</div>
